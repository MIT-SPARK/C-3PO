...
# Train
def train_detector(hyper_param, detector_type='point_transformer', model_id="003_cracker_box"):
    """
...
if __name__ == "__main__":
    ...
    #                        evaluate_models=True, visualize_with_corrector=True, visualize_without_corrector=False,
