...
from learning_objects.datasets.keypointnet2 import DepthPC
from learning_objects.datasets.keypointnet2 import CLASS_NAME, CLASS_ID, DepthPC
...
def eval_icp(class_id, model_id, hyper_param, certification=True, visualize=False):
    ...
    # if visualize:
    #     display_two_pcs(pc1=cad_models[0, ...], pc2=cad_models[0, ...])
    ...
    for i, vdata in enumerate(eval_loader):
        ...
        # predicted_keypoints = R_predicted @ model_keypoints + t_predicted
        ...
        del input_point_cloud, keypoints_target, R_target, t_target, \
            predicted_point_cloud, R_predicted,
...
def evaluate_icp(model_class_ids, only_categories, visualize=False):
...
if __name__ == "__main__":
    """
    usage: 
    >> python test_icp.py "chair"
    >> python test_icp.py "table"
