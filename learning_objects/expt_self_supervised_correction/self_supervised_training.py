...
##
def train_detector(hyper_param, detector_type, class_id, model_id):
    """
    ...
    val_dataset = DepthPC(class_id=class_id, model_id=model_id,
                          n=num_of_points_selfsupervised,
                          num_of_points_to_sample=num_of_points_to_sample,
                          dataset_len=val_dataset_len, rotate_about_z=True)
    ...
    model = ProposedModel(class_name=class_name, model_keypoints=model_keypoints, cad_models=cad_models,
                          # Use this for self-supervised training of a pre-trained point_net or point-transformer
    ...
    train_without_supervision(self_supervised_train_loader=self_supervised_train_loader,
                              # Use this for self-supervised training
...
if __name__ == "__main__":
    ...
    stream = open("self_supervised_training_kp_detector.yml", 'r')
