...
ANNOTATIONS_FOLDER: str = '../../data2/KeypointNet/KeypointNet/annotations/'
PCD_FOLDER_NAME: str = '../../data2/KeypointNet/KeypointNet/pcds/'
MESH_FOLDER_NAME: str = '../../data2/KeypointNet/ShapeNetCore.v2.ply/'
...
def temp_expt_1_viz(cad_models, model_keypoints, gt_keypoints=None):
...
def generate_depth_data(class_id, model_id, radius_multiple = [1.2, 3.0],
                        ...
                        dir_location='../../data2/learning-objects/keypointnet_datasets/'):
...
class FixedDepthPC(torch.utils.data.Dataset):
    ...
    def __init__(self, class_id, model_id, n=1000, radius_multiple=torch.tensor([1.2, 3.0]),
                 ...
                 base_dataset_folder='../../data2/learning_objects/shapenet_depthpc_eval_data/'):
        super().__init__()
        """
        class_id        : str   : class id of a ShapeNetCore object
        model_id        : str   : model id of a ShapeNetCore object 
...
class DepthPointCloud(torch.utils.data.Dataset):
    ...
    given CAD model.
    """
    def __init__(self, class_id, model_id, dir_name='../../data2/learning_objects/keypointnet_datasets/',
...
if __name__ == "__main__":
    ...
    dir_location = '../../data2/learning_objects/keypointnet_datasets/'
