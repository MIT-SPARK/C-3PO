...
from learning_objects.datasets.shapenet import SE3nIsotropicShapePointCloud, \
...
from learning_objects.datasets.shapenet import CLASS_NAME as KEYPOINTNET_ID2NAME, \
    CLASS_ID as KEYPOINTNET_NAME2ID

from learning_objects.models.keypoint_corrector import kp_corrector_pace, keypoint_perturbation
...
from learning_objects.utils.evaluation_metrics import shape_error, translation_error, rotation_error
...
if __name__ == "__main__":
    ...
    # run_experiments_on(class_id=class_id, model_id=model_id, kp_noise_fra=0.8, only_visualize=False)
