...
if __name__ == '__main__':
    file_names = ["./expt_with_reg_depthpc/02818832/7c8eb4ab1f2c8bfa2fb46fb8b9b1ac9f/20220208_203138_experiment.pickle",
                  "./expt_with_reg_depthpc/03001627/1cc6f2ed3d684fa245f213b8994b4a04/20220208_194646_experiment.pickle"]
    ...
    for name in file_names:
        ...
        certi_naive, certi_corrector = certification(data, epsilon=.99, delta=.5, full_batch=True)
        certi_naive = certi_naive.to('cpu')
        certi_corrector = certi_corrector.to('cpu')

        sqdist_input_naiveest = data['sqdist_input_naiveest']
        sqdist_input_correctorest = data['sqdisdt_input_correctorest']
        sqdist_kp_naiveest = data['sqdist_kp_naiveest']
        sqdist_kp_correctorest = data['sqdist_kp_correctorest']
