...
from c3po.datasets.ycb import DepthYCB, DepthYCBAugment, MixedDepthYCBAugment
from c3po.utils.general import TrackingMeter
from c3po.utils.visualization_utils import display_results, viz_rgb_pcd
...
def visualize_detector(hyper_param, detector_type, model_id,
    ...
    if evaluate_models:
        if pre_:
            ...
            print(">>" * 40)
            log_dir = 'eval/ycb/' + str(detector_type) + '/pre/' + str(model_id) + '/' + str(dataset_model_id)
        ...
        if post_:
            ...
            print(">>" * 40)
            log_dir = 'eval/ycb/' + str(detector_type) + '/post/' + str(model_id) + '/' + str(dataset_model_id)
